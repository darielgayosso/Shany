  ...
  loveEnvelopes: [
    {
      ...
      openWhen: 'Cuando me extrañes mucho',
      message: 'Cierra los ojos un segundo y recuerda mi abrazo apretado y la forma en que te sostengo, que no importa nada mas, mi corazón está siempre contigo. Llámame o mándame un mensaje, siempre tengo tiempo para ti. Te amo mucho mucho muchisimo.',
    },
    {
      id: 'env-2',
      title: 'Abre esto cuando tengas un día difícil',
      openWhen: 'Cuando algo no salga como esperabas',
      message: 'Respira profundo mi amor. Eres muy pero muy capaz, fuerte, inteligente y hermosa. Los días difíciles pasan, pero tu esfuerzo se queda. Estoy increíblemente orgulloso de ti y aquí estoy para escucharte o consentirte mi niña',
    },
    {
      id: 'env-3',
      title: 'Abre esto cuando quieras sonreír',
      openWhen: 'Cualquier momento en que necesites una sonrisa en tu rostro',
      message: 'Sabías que cada vez que sonríes iluminas todo a tu alrededor? Tienes la risa más bonita del universo y la mitad de las cosas tontas que hago son solo para ver esa sonrisa en tu carita, gracias por hacerme el hombre más afortunado del mundo',
    },
    {
      id: 'env-4',
      title: 'Abre esto cuando dudes de lo mucho que te amo',
      openWhen: 'Si alguna vez te preguntas cuánto significas para mí',
      message: 'Si contara las estrellas en el cielo, aún me faltarían números para expresar lo mucho que te amo. Eres mi hogar, mi paz, mi cómplice y mi futura historia favorita. Eres y serás siempre el amor de mi vida y de mi alma',
    },
  ],
  loveReasons: [
